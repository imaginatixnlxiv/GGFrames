...
public class GGFrames {
	...
	public void Char_Assign() {
		...
		CharList.add(
				new Characters("Answer", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Answer/Frame_Data"));

		CharList.add(
				new Characters("Axl Low", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Axl_Low/Frame_Data"));
		CharList.add(
				new Characters("Baiken", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Baiken/Frame_Data"));
		CharList.add(
				new Characters("Bedman", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Bedman/Frame_Data"));
		CharList.add(new Characters("Chipp Zanuff",
				"http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Chipp_Zanuff/Frame_Data"));
		CharList.add(new Characters("Dizzy", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Dizzy/Frame_Data"));
		CharList.add(new Characters("Elphelt Valentine",
				"http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Elphelt_Valentine/Frame_Data"));
		...
		CharList.add(
				new Characters("Jack-O", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Jack-O%27/Frame_Data"));
		CharList.add(new Characters("Jam Kuradoberi",
				"http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Jam_Kuradoberi/Frame_Data"));
		CharList.add(
				new Characters("Johnny", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Johnny/Frame_Data"));
		CharList.add(new Characters("Kum Haehyun",
				"http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Kum_Haehyun/Frame_Data"));
		CharList.add(new Characters("Ky Kiske",
				"http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Ky_Kiske/Frame_Data"));
		CharList.add(new Characters("Leo Whitefang",
				"http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Leo_Whitefang/Frame_Data"));
		CharList.add(new Characters("May", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/May/Frame_Data"));
		CharList.add(new Characters("Millia Rage",
				"http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Millia_Rage/Frame_Data"));
		CharList.add(new Characters("Potemkin",
				"http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Potemkin/Frame_Data"));
		CharList.add(new Characters("Ramlethal Valentine",
				"http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Ramlethal_Valentine/Frame_Data"));
		CharList.add(new Characters("Raven", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Raven/Frame_Data"));
		CharList.add(new Characters("Sin Kiske",
				"http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Sin_Kiske/Frame_Data"));
		CharList.add(
				new Characters("Slayer", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Slayer/Frame_Data"));
		CharList.add(new Characters("Sol Badguy",
				"http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Sol_Badguy/Frame_Data"));
		CharList.add(new Characters("Venom", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Venom/Frame_Data"));
		CharList.add(
				new Characters("Zato-1", "http://www.dustloop.com/wiki/index.php?title=GGXRD-R2/Zato-1/Frame_Data"));
